...
class hpf_vi():
    ...
    def fit(self, train, iterations, valid=None):
        '''
        ...
        if valid.shape[0] == train.shape[0]:
        ...
        for iter in range(iterations):
            ...
            #In-sample MSE
            self.mse_train[iter] = MSE(self.predicted, self.train)

            #Out-of-sample MSE
            if valid.shape[0] == train.shape[0]:
                self.mse_valid[iter] = MSE(self.predicted, self.valid)
